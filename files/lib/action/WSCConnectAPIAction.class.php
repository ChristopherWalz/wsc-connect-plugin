...
class WSCConnectAPIAction extends AbstractAjaxAction {
	 ...
	 * @var	array
	 */
	public $guestTypes = array('apiUrlValidation', 'loginCookie', 'getAvailableTabs');
	...
	private function getAvailableTabs() {
		$tabs = array('webview', 'notifications', 'messages');
	...
	private function getConversationMessages() {
		...
		$objectList->getConditionBuilder()->add('conversation_message.conversationID = ?', array($conversation->conversationID));
